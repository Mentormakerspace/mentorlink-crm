...
def login():
    ...
    try:
        ...
        print("[DEBUG] Login raw data:", request.data)
        data = request.get_json()
        print("[DEBUG] Login parsed JSON:", data)
        if not data or not data.get('email') or not data.get('password'):
            print("[ERROR] Missing email or password in login.")
        ...
        print(f"[INFO] User logged in: {user_data}")
